...
class yolov8sInput : MLFeatureProvider {
...
@available(macOS 11.0, iOS 14.0, tvOS 14.0, watchOS 7.0, *)
class yolov8sOutput : MLFeatureProvider {
...
class yolov8s {
    ...
    class var urlOfModelInThisBundle : URL {
        ...
        return bundle.url(forResource: "yolov8s", withExtension:"mlmodelc")!
    }

    /**
        Construct yolov8s instance with an existing MLModel object.

        Usually the application does not use this initializer unless it makes a subclass of yolov8s.
        Such application may want to use `MLModel(contentsOfURL:configuration:)` and `yolov8s.urlOfModelInThisBundle` to create a MLModel object to pass-in.
    ...
    */
    ...
    /**
        Construct yolov8s instance with explicit path to mlmodelc file
        - parameters:
    ...
    */
    ...
    /**
        Construct yolov8s instance asynchronously with optional configuration.
    ...
    */
    class func load(configuration: MLModelConfiguration = MLModelConfiguration(), completionHandler handler: @escaping (Swift.Result<yolov8s, Error>) -> Void) {
    ...
    */
    @available(macOS 12.0, iOS 15.0, tvOS 15.0, watchOS 8.0, *)
    class func load(configuration: MLModelConfiguration = MLModelConfiguration()) async throws -> yolov8s {
        return try await self.load(contentsOf: self.urlOfModelInThisBundle, configuration: configuration)
    }

    /**
        Construct yolov8s instance asynchronously with URL of the .mlmodelc directory with optional configuration.
        ...
        - parameters:
          ...
          - handler: the completion handler to be called when the model loading completes successfully or unsuccessfully
    */
    class func load(contentsOf modelURL: URL, configuration: MLModelConfiguration = MLModelConfiguration(), completionHandler handler: @escaping (Swift.Result<yolov8s, Error>) -> Void) {
        MLModel.load(contentsOf: modelURL, configuration: configuration) { result in
            switch result {
            case .failure(let error):
                handler(.failure(error))
            case .success(let model):
                handler(.success(yolov8s(model: model)))
            }
        }
    }
    ...
    */
    @available(macOS 12.0, iOS 15.0, tvOS 15.0, watchOS 8.0, *)
    class func load(contentsOf modelURL: URL, configuration: MLModelConfiguration = MLModelConfiguration()) async throws -> yolov8s {
        let model = try await MLModel.load(contentsOf: modelURL, configuration: configuration)
        return yolov8s(model: model)
    }
    ...
    /**
        ...
        - parameters:
           - input: the input to the prediction as yolov8sInput

        - throws: an NSError object that describes the problem

        - returns: the result of the prediction as yolov8sOutput
    */
    func prediction(input: yolov8sInput) throws -> yolov8sOutput {
    ...
    /**
        ...
        - returns: the result of the prediction as yolov8sOutput
    */
    func prediction(input: yolov8sInput, options: MLPredictionOptions) throws -> yolov8sOutput {
        let outFeatures = try model.prediction(from: input, options:options)
        return yolov8sOutput(features: outFeatures)
    }
    ...
    */
    ...
    func prediction(input: yolov8sInput, options: MLPredictionOptions = MLPredictionOptions()) async throws -> yolov8sOutput {
    ...
    /**
        ...
        - returns: the result of the prediction as yolov8sOutput
    */
    func prediction(image: CVPixelBuffer, iouThreshold: Double, confidenceThreshold: Double) throws -> yolov8sOutput {
        let input_ = yolov8sInput(image: image, iouThreshold: iouThreshold, confidenceThreshold: confidenceThreshold)
    ...
    /**
        ...
        - parameters:
           - inputs: the inputs to the prediction as [yolov8sInput]
           - options: prediction options 
        ...
        - returns: the result of the prediction as [yolov8sOutput]
    */
    func predictions(inputs: [yolov8sInput], options: MLPredictionOptions = MLPredictionOptions()) throws -> [yolov8sOutput] {
        let batchIn = MLArrayBatchProvider(array: inputs)
        let batchOut = try model.predictions(from: batchIn, options: options)
        var results : [yolov8sOutput] = []
        results.reserveCapacity(inputs.count)
        for i in 0..<batchOut.count {
            let outProvider = batchOut.features(at: i)
            let result =  yolov8sOutput(features: outProvider)
